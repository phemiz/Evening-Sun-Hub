  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-right duration-300 pb-20">
      ...
      <div className="space-y-8">
            ...
            <div className="flex items-center justify-between p-5 border-b border-slate-50 dark:border-slate-700/50">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Receive app notifications</span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-5 border-b border-slate-50 dark:border-slate-700/50">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Receive email receipts</span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-5">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Promotions and special offers</span>
                </div>
              </div>
        ...
        {/* Sync & Offline Status */}
        <div className="space-y-3">
          <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] px-4">Connection Status</h3>
          <div className="bg-white dark:bg-slate-800 rounded-[2rem] border border-slate-100 dark:border-slate-700 p-5 shadow-sm space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-700 dark:text-slate-200">Server Connection</span>
                  <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest">{isOnline ? 'Online' : 'Offline'}</span>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className="text-[9px] text-red-400 font-bold uppercase tracking-widest">Delete your account data</span>
                </div>
              </div>
          ...
          <div className="w-full max-sm:w-full max-w-sm bg-white dark:bg-slate-900 rounded-t-[2.5rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-10 sm:zoom-in duration-500 max-h-[90dvh] flex flex-col">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 flex-shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-black dark:text-white uppercase tracking-tight leading-none">Change Password</h3>
              </div>
              ...
              {passUpdated ? (
                <div className="py-10 text-center space-y-4 animate-in zoom-in duration-300">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-xl font-black dark:text-white uppercase tracking-tight">Password Updated</h4>
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-red-950/40 backdrop-blur-md p-4 animate-in fade-in duration-300">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-10 duration-500">
            <div className="p-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Confirm Deletion</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                  Proceeding will permanently delete your **Loyalty Points**, your booking history, and wallet balance. This deletion is irreversible.
                </p>
              </div>
              <div className="space-y-3 pt-4">
                ...
                >
                  {isDeleting ? <span className="flex items-center gap-2"><div className="w-4 h-4 border-2 border-white/50 border-t-white rounded-full animate-spin" /> DELETING...</span> : "CONFIRM DELETE"}
                </button>
                <button onClick={() => setShowDeleteConfirm(false)} disabled={isDeleting} className="w-full text-slate-400 font-black text-[9px] uppercase tracking-[0.4em] py-3">CANCEL</button>
              </div>
            </div>
          </div>
        </div>
